    ...
    <div class="container main_content">
        <div class="row">
            <article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
                ...
                <section class="home-banner">
                    <div class="container" data-aos="fade-in">
                        ...
                        <div class="row">
                            ...
                            $id_featured = ConfigurationParameters::getTermIdByName(
                                ConfigurationParameters::$name_term_featured,
                                ConfigurationParameters::$slug_taxonomy_main
                            );
                                        ...
                                        <a href="<?php the_permalink(); ?>">
                                            <div style="background-image: url('<?php echo $image_[0]; ?>')"
                                                ...
                                                <div class="bottom-div">
                                                    ...
                                                    $arr_name_terms_model = get_post_terms_data(
                                                        $post->ID,
                                                        ConfigurationParameters::$slug_taxonomy_location
                                                    );
                                            ...
                                            <div class="col-xs-6">
                                                <div class="thum-box-div" data-aos="zoom-in-up">
                                                    ...
                                                    <div class="bottom-div">
                                                        <?php
                                                        // get used cities for model
                                                        $arr_name_terms_model = get_post_terms_data($post->ID, ConfigurationParameters::$slug_taxonomy_location);
                ...
                <article>
                    <section
                            style="background-image: url(https://www.eroticlondonescorts.com/wp-content/themes/berest/images/welcom-bg.jpg)"
                    ...
                    <section class="hot-modal-section paddingTB50" data-aos="fade-in">
                        <div class="container">
                            ...
                            <ul class="col5-row">
                                <?php
                                //remove_all_filters('posts_orderby');
                                // create new loop for 5 models from other categories except 'Featured'
                                    ...
                                    <li>
                                        <div class="post-block-div">
                                            ...
                                            <div class="bottom-content">
                                                <h3><?php the_title(); ?></h3>
                                                                                    <?php
                                                                                    $arr_name_terms_model = get_post_terms_data($post->ID, ConfigurationParameters::$slug_taxonomy_main);
                                                                                    echo $arr_name_terms_model[0];
                                                                                    ?>
                                            </div>
                                        </div>
                    ...
                    <section class="our-blog-section paddingB50" data-aos="fade-in">
                        <div class="container">
                            ...
                            $id_blog = ConfigurationParameters::getTermIdByName(
                                ConfigurationParameters::$name_term_blog,
                                ConfigurationParameters::$slug_taxonomy_main
                            );
