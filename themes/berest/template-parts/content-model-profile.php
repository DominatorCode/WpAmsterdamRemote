						...
						<div class="block-div">
							...
							<div class="content-div">
								<table>
									...
									$list_terms = ConfigurationParameters::GetTermsList(ConfigurationParameters::$data_terms_input_range['Taxonomy'],
										ConfigurationParameters::$data_terms_input_range['Id']);

									// Get Rates sub terms data and print
									foreach ($list_terms as $obj_term) {
										$value_meta_rates_in = RawCF::GetValueTerm($obj_term, $idPost, ConfigurationParameters::$name_postfix_rates_in);
										$value_meta_rates_out = RawCF::GetValueTerm($obj_term, $idPost, ConfigurationParameters::$name_postfix_rates_out);
