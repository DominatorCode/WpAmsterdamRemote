...
class Image_Gallery_Metabox {
	...
	private function define_admin_hooks() {
		...
		$this->loader->add_action( 'wp_ajax_my_cropeimage_url', $plugin_admin, 'my_cropeimage_url' );



		// ajax crop image

		$this->loader->add_action( 'wp_ajax_nopriv_my_cropeimage_url', $plugin_admin, 'my_cropeimage_url' );



		// ajax crop image edit

		$this->loader->add_action( 'wp_ajax_my_cropeimage_edit_url', $plugin_admin, 'my_cropeimage_edit_url' );



		// ajax crop image edit

		$this->loader->add_action( 'wp_ajax_nopriv_my_cropeimage_edit_url', $plugin_admin, 'my_cropeimage_edit_url' );



		add_shortcode('gallery_metabox_shortcode',array($plugin_admin, 'image_gallery_metabox_shortcode'));
