            ...
            function init()
                {
                    ...
                    include_once(CPTPATH . '/includes/class.walkers.php');
            ...
            function archiveDragDrop()
                {
                    ...
                    wp_enqueue_style('cpt-archive-dd', CPTURL . '/assets/cpt-archive-dd.css');
                    
                    wp_enqueue_script('jquery');
                    wp_enqueue_script('jquery-ui-sortable');
                    wp_register_script('cpto', CPTURL . '/assets/cpt.js', array('jquery')); 
            ...
            function registerFiles() 
                {
                    ...
                    wp_register_style('CPTStyleSheets', CPTURL . '/assets/cpt.css');
